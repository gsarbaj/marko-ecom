...
import { FaAlignRight, FaEnvelope, FaFacebookF, FaTelegramPlane, FaViber, FaVk, FaWhatsapp } from "react-icons/fa"
    ...
    <header>
      <div className={"header"}>
        ...
        <div className={'socials'}>
          ...
          <a href={'/'} target="_blank" title="Написать в Whatsapp">
            <FaWhatsapp/>
          </a>
          <a href={'/'} target="_blank" title="Написать в Facebook">
            <FaFacebookF/>
          </a>
          <a href='viber://pa?chatURI=obuv_optom' target="_blank" title="Написать в Viber">
            <FaViber/>
          </a>
          <a href={'/'} target="_blank" title="Написать в ВКонтакте">
            <FaVk/>
          </a>
